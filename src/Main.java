...
public static void main(String[] args) {
        ...
        System.out.println("Birinci: " + birincilik(yarismacilar, dereceler) + " dakika ");
        System.out.println("İkinci: " + ikincilik(yarismacilar, dereceler) + " dakika ");
        System.out.println("Üçüncü: " + ucunculuk(yarismacilar, dereceler) + " dakika ");
